...
class ShopProfileModel {
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'displayBaseDeliveryFee': displayBaseDeliveryFee,
      'estimatedTime': estimatedTime,
      'displayMinOrderAmount': displayMinOrderAmount,
      'phone': phone,
      'email': email,
      'isOpen': isOpen,
      'addressEn': addressEn,
      ...
      'maxItemQuantityPerOrder': maxItemQuantityPerOrder,
